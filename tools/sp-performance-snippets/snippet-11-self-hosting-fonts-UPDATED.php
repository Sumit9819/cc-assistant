...
add_action( 'wp_head', function () {
	...
	// Homepage only (2026-09-17): this is the homepage slider image. On every
	// other page it was a wasted high-priority download of ~174 KB.
	if ( is_front_page() ) {
	...
	// Lato 700 (main menu) and 900 (company name in the top bar) added
	// 2026-09-17: without them the desktop menu wrapped to a second line in
	// the fallback font, then snapped back when Lato arrived, moving the whole
	// page up 29px. Measured CLS 0.36-0.42 -> 0.042-0.045 on category,
	// product and content pages, 3 runs each.
	foreach ( array( 'lato-400.woff2', 'lato-700.woff2', 'lato-900.woff2', 'archivo-black-400.woff2', 'lato-700-italic.woff2' ) as $critical ) {
		printf(
