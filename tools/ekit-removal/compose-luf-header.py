"""Builds the REVAMPED, ElementsKit-free header for ER of Lufkin (template 7151).

Direction chosen by the operator 2026-09-18: a slim red trust strip over a white
...
Colours, type and spacing follow the eroflufkin-design skill: #DA1212 primary,
...
DIRECTIONS = 'https://maps.app.goo.gl/uMX3wBgdL4rSjKsN8'
...
trust = widget('luftrust', 'icon-list', dict(strip_text, **{
    '_element_id': 'luf-trust',
    ...
    # every page already states telephone +19364271313 and 501 N Brentwood Dr,
    # Lufkin, TX 75904, so this keeps the two in step sitewide.
    'icon_list': [
        {'_id': 'luftr1', 'text': 'Open 24/7', 'selected_icon': fa('fas fa-clock'), 'link': link('')},
        {'_id': 'luftr2', 'text': PHONE_TXT, 'selected_icon': fa('fas fa-phone-alt'),
         'link': link(PHONE_TEL, CALL_ARIA)},
        {'_id': 'luftr3', 'text': ADDRESS, 'selected_icon': fa('fas fa-map-marker-alt'),
         'link': link(DIRECTIONS, 'aria-label|Get directions to ER of Lufkin, 501 N Brentwood Dr')},
        {'_id': 'luftr4', 'text': 'Directions', 'selected_icon': fa('fas fa-map-marker-alt'),
         'link': link(DIRECTIONS, 'aria-label|Get directions to ER of Lufkin')},
    ],
}))
...
strip = container('lufstrip', {
    '_element_id': 'luf-strip',
...
nav = widget('lufnav', 'nav-menu', {
    ...
    'padding_horizontal_menu_item': size(10),
...
call_full = widget('lufcall', 'button', dict(button_base, **{
...
call_short = widget('lufcalls', 'button', dict(button_base, **{
    '_element_id': 'luf-call-short',
    'text': 'Call',
...
RESPONSIVE_CSS = (
    ...
    '#luf-call-short{display:none}'
    '#luf-trust .elementor-icon-list-item:nth-child(4){display:none}'
    # --- tablet ---------------------------------------------------------------
    ...
    '#luf-logocol{width:34%}#luf-navcol{width:28%;justify-content:flex-end}#luf-ctacol{width:38%}'
    '#luf-logocol,#luf-navcol,#luf-ctacol{padding:0 8px}'
    '#luf-strip{padding:6px 16px}'
    '#luf-strip>.e-con-inner{flex-direction:row!important;flex-wrap:nowrap!important}'
    # "No appointment needed" is the longest line and the first to crowd
    '#luf-trust .elementor-icon-list-item:nth-child(1){display:none}'
    '#luf-nav nav.elementor-nav-menu--dropdown{position:absolute!important;top:100%!important;'
    'left:0!important;width:100%!important;z-index:999;margin-top:0!important;background:#FFFFFF;'
    'border-top:2px solid #DA1212;box-shadow:0 12px 28px rgba(0,0,0,.14);'
    'max-height:calc(100vh - 150px);overflow-y:auto}'
    '}'
    '@media(max-width:900px){#luf-social{display:none}}'
    # --- phone ----------------------------------------------------------------
    '@media(max-width:767px){'
    '#luf-social{display:none}'
    '#luf-call{display:none}#luf-call-short{display:block}'
    '#luf-strip{padding:8px 16px}'
    '#luf-strip>.e-con-inner{justify-content:center;flex-wrap:nowrap!important}'
    # phones keep the tappable number and a short Directions link
    '#luf-trust .elementor-icon-list-item:nth-child(1),'
    '#luf-trust .elementor-icon-list-item:nth-child(3){display:none}'
    '#luf-trust .elementor-icon-list-item:nth-child(4){display:inline-block}'
    '#luf-trust .elementor-icon-list-item a,#luf-trust .elementor-icon-list-item{min-height:36px}'
    '#luf-trust .elementor-icon-list-text{font-size:15px}'
    '#luf-mainbar{padding:8px 12px}'
    # logo, call, burger in that order: the CTA sits under the thumb, not behind a menu
    '#luf-logocol{width:44%;order:1}#luf-ctacol{width:31%;order:2}#luf-navcol{width:25%;order:3}'
    '#luf-logocol,#luf-navcol,#luf-ctacol{padding:0 4px}'
    '#luf-logo img{width:170px}'
    '}'
)
