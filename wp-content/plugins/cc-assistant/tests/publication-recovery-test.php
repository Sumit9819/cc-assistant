...
function publication_fixture() {
    ...
    set_transient($key->invoke(null,'post',1),['observed_at'=>time(),'post_hash'=>CC_Assistant_Integrity::post_hash(1),'environment_hash'=>CC_Assistant_Evidence_Gate::environment_material_hash(),'kind'=>'editor'],600);
