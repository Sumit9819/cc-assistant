...
class CC_Assistant_Integrity {
	...
	public static function post_hash( $post_id ) {
		...
		foreach ( array_keys( $meta ) as $key ) {
			if ( in_array( $key, array( '_edit_lock', '_edit_last', '_elementor_css', '_elementor_element_cache', '_elementor_page_assets', '_elementor_controls_usage', '_elementor_inline_svg', '_cc_assistant_content_workflow' ), true )
