...
class CC_Assistant_Apply {
	 ...
	 */
	public static function apply_pending( $pending_id, $reviewer_id, $bulk_mode = false ) {
		...
		try {
			$result = self::apply_pending_impl( $pending_id, $reviewer_id, $bulk_mode, $claimed );
	...
	private static function apply_pending_impl( $pending_id, $reviewer_id, $bulk_mode, &$claimed ) {
