...
body='''# CC Assistant 0.89.0 — implementation and site review
...
'''
body=body.replace('PACKAGE_HASH',manifest['sha256'])
(report/'IMPLEMENTATION-0.89.0.md').write_text(body,encoding='utf-8')
print(str(report/'IMPLEMENTATION-0.89.0.md'))
