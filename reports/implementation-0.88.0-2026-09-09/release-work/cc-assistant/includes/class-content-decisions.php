...
class CC_Assistant_Content_Decisions {
	...
	public static function research( $args ) {
		...
		return self::save( 'research', array( $own['content_hash'], $context, $hashes ), $result );
	}
	...
	private static function research_topic( $args ) {
		...
		return self::save( 'research', array( $topic, $goal, $contribution, $anchor['evidence_id'], $scope['scope_revision'], $scope['context']['context_hash'], $context, $hashes, $inventory, $inventory_basis ), $result );
	}
