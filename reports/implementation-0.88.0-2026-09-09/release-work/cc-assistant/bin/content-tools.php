...
$cc_names = array( 'get_content_scope', 'discover_content_scope', 'manage_content_scope', 'plan_blog_content', 'content_research', 'content_decision', 'content_decision_history', 'content_workflow', 'verify_content_workflow', 'inspect_plugin_capability' );
$cc_selected = array();
