...
requests=[{'jsonrpc':'2.0','id':1,'method':'initialize','params':{'protocolVersion':'2024-11-05','capabilities':{},'clientInfo':{'name':'release-fixture','version':'1'}}},{'jsonrpc':'2.0','id':2,'method':'tools/list','params':{}}]
...
required=['get_content_scope','plan_blog_content','content_research','content_decision','content_decision_history','discover_content_scope','manage_content_scope','content_workflow']
