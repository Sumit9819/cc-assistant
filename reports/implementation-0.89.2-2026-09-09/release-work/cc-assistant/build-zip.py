...
def main():
    required = ["bin/mcp-server.php", "bin/browser-transport.php", "bin/browser-transport.mjs", "bin/browser/package.json", "bin/automation-runner.py", "bin/agent-contract.php", "bin/tool-catalog.php"]
