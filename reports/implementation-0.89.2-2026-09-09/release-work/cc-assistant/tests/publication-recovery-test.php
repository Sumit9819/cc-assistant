...
function publication_fixture() {
    ...
    foreach (['source_stale','author_fail','binding_fail','claim_race','gate_fail','environment_drift','draft_drift','storage_fail','write_lock_busy'] as $key) $GLOBALS[$key]=false;
