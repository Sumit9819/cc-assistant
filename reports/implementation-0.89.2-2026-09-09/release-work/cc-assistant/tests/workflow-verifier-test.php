...
class VerifierDB extends ScopeDB { public function get_row( $sql ) { return $GLOBALS['pending_fixture'] ?? null; } }
...
$GLOBALS['pending_fixture'] = (object) array( 'id' => 71, 'post_id' => 901, 'change_type' => 'publish_draft', 'status' => 'pending' );
...
unset( $GLOBALS['pending_fixture']->pre_check_baseline );
