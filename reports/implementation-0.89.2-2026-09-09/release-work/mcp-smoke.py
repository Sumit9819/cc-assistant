...
assert 'refresh_publish_proposal' in by_name
assert not by_name['refresh_publish_proposal']['annotations']['readOnlyHint']
assert set(by_name['refresh_publish_proposal']['inputSchema']['required'])=={'pending_id','workflow_id','reason'}
