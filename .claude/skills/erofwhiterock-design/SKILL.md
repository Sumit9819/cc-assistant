...
- **Support consequential claims with suitable current sources.** Use numbers only when they help the reader; a citation count does not establish accuracy or ranking quality.
- **Use headings that answer the actual reader task.** Question headings can help navigation; this is a writing choice, not a demonstrated ranking advantage.
